...
> 📸 **Image build:** `docs/images/docker/docker-10-image-build.png`
>
> 📸 **Container·HTTP 검증:** `docs/images/docker/docker-14-http-response.png`
...
> 📸 **Bind Mount 반영:** `docs/images/docker/docker-19-bind-after-update.png`
>
> 📸 **Volume 영속성:** `docs/images/docker/docker-27-volume-persistence.png`

![Bind Mount 실시간 변경 반영](https://raw.githubusercontent.com/yhana972/Codyssey_E1-1/main/docs/images/docker/docker-19-bind-after-update.png)
![컨테이너 재생성 후 Volume 데이터 유지](https://raw.githubusercontent.com/yhana972/Codyssey_E1-1/main/docs/images/docker/docker-27-volume-persistence.png)
...
> 📸 **Compose 실행 상태:** `docs/images/docker/docker-57-multi-compose-ps.png`

![Docker Compose 서비스 실행 상태](https://raw.githubusercontent.com/yhana972/Codyssey_E1-1/main/docs/images/docker/docker-57-multi-compose-ps.png)
